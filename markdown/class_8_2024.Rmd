...
```{r}
census_api_key("ea48b950b6328a9a01bcfcb61fed774c017b877a", overwrite = TRUE)
```
...
ggplot()+
  geom_sf(data = acs2020_incidents,
          aes(fill = n_per_sqmi), color = "lightgray")+
  theme_minimal()+
  labs(title = 'Illegal Dumping Incidents per Square Mile', subtitle="Philadelphia 2020", caption = "Concentration of Illegal Dumping along the Eastern Border \n and Delware River  and into the Center City path", fill="Dumpings per sq. mile")+
